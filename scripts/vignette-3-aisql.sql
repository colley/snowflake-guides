...
select * from TB_101.HARMONIZED.TRUCK_REVIEWS_V limit 1;

SELECT snowflake.cortex.complete('mistral-large2', 'Summarize the following text: ' || REVIEW) FROM TB_101.HARMONIZED.TRUCK_REVIEWS_V LIMIT 1;
